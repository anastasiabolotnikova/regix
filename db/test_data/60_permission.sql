...
INSERT INTO `permission` (`name`,`description`,`permission_category_id`) VALUES ('add_service','User can add new services to the system.',7);
...
INSERT INTO `permission` (`name`,`description`,`permission_category_id`) VALUES ('edit_service','Users can edit all services in the system.',7);
...
INSERT INTO `permission` (`name`,`description`,`permission_category_id`) VALUES ('list_services','Users can see details of all services in the system.',7);
...
INSERT INTO `permission` (`name`,`description`,`permission_category_id`) VALUES ('delete_service','User can delete any service from the system.',7);
