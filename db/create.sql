...
CREATE PROCEDURE `create_event` (
	IN p_calendar_id INT,
	IN p_user_id INT,
	IN p_description VARCHAR(200),
	IN p_assigned_user INT,
	IN p_assigned_service VARCHAR(45),
	IN p_from TIMESTAMP,
	IN p_to TIMESTAMP
)
BEGIN
	SET @calendar_id = p_calendar_id,
		...
		@assigned_user = p_assigned_user,
		@assigned_service = p_assigned_service,
		@from_ = p_from,
		@to_ = p_to; /* DO NOT SPLIT */
